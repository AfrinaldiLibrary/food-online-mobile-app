...
public class Cart extends AppCompatActivity {
    ...
    private void showAlrtDialog() {
        ...
        alartDialog.setTitle("ALAMAT PENGIRIMAN");
        alartDialog.setMessage("masukan alamat :");
        ...
        alartDialog.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Toast.makeText(Cart.this, "Pesanan Berhasil", Toast.LENGTH_SHORT).show();
                finish();
            }
        });

        alartDialog.setNegativeButton("Tidak", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
